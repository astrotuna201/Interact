...
public extension View {
  ...
  func rotatable<RotationHandle: View>(id: String, initialSize: CGSize, includesRotationGesture: Bool = true,  @ViewBuilder handle: @escaping (Bool, Bool) -> RotationHandle) -> some View {
  ...
  func rotatable<RotationHandle: View>(id: String, initialSize: CGSize, includesRotationGesture: Bool = true,  @ViewBuilder handle: @escaping (Bool, Bool) -> RotationHandle, dragType: DragType) -> some View {
        
        switch dragType {
        case .drag:
            return AnyView(self.injectDependencies(id: id, initialSize: initialSize) { (dependencies)  in
  ...
  func spinnable<RotationHandle: View>(id: String, initialSize: CGSize = CGSize(width: 100, height: 100), includesRotationGesture: Bool = true, model: AngularVelocityModel = AngularVelocity(), threshold: CGFloat = 0, @ViewBuilder handle: @escaping (Bool, Bool) -> RotationHandle, dragType: DragType) -> some View {
  ...
  func spinnable<RotationHandle: View>(id: String, initialSize: CGSize = CGSize(width: 100, height: 100), includesRotationGesture: Bool = true, model: AngularVelocityModel = AngularVelocity(), threshold: CGFloat = 0, @ViewBuilder handle: @escaping (Bool, Bool) -> RotationHandle) -> some View {
    self.injectDependencies(id: id, initialSize: initialSize) { (dependencies)  in
